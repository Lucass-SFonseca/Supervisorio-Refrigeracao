...
class MainApp(App):
    ...
    def build(self):
        ...
        modbus_addrs = {
            'Velocidade_saida_ar': {'addr': 712, 'tipo': 'FP','div': 1, 'ymin': 0, 'ymax': 5},
            'Vazao_saida_ar': {'addr':714, 'tipo': 'FP','div': 1, 'ymin': 0, 'ymax': 400},
            'Temperatura': {'addr':710, 'tipo': 'FP','div': 1, 'ymin': 0, 'ymax': 50},
            'Med_demanda': {'addr':1205, 'tipo': 'FP','div': 10, 'ymin': 0, 'ymax': 5},
            'Velocidade_compresor': {'addr':1236, 'tipo': 'FP','div': 1, 'ymin': 0, 'ymax': 5},
            'Alarme_Temperatura_baixa': {'addr':1231, 'tipo': 'FP','div': 1, 'ymin': 0, 'ymax': 5},
            'Corrente_media': {'addr':845, 'tipo': 'FP','div': 0.001, 'ymin': 0, 'ymax': 5},
            ...
            'Potencia_ativa': {'addr':735, 'tipo': 'FP','div': 1, 'ymin': 0, 'ymax': 1000},
