...
class MainApp(App):
    ...
    def build(self):
        ...
        modbus_addrs = {
            ...
            'corrente_media': {'addr':845, 'tipo': '4X', 'ymin': 0, 'ymax': 5,'nick':'Corr. média', 'label':'Corrente Média', 'l/e': 'l', 'div': 10, 'valor': 1, 'unid': 'A'},
            ...
            'potencia_ativa_total': {'addr':855, 'tipo': '4X','div': 1, 'ymin': 0, 'ymax': 150, 'nick':'Pot. Ativa', 'label':'Potência Ativa', 'l/e': 'l', 'div': 1, 'unid': 'W'},
            ...
            'Temperatura_saida': {'addr':710, 'tipo': 'FP', 'ymin': 0, 'ymax': 50, 'nick':'Temp. saída', 'label':'Temperatura de Saída', 'l/e': 'l', 'div': 1, 'valor': 1, 'unid': '°C'},
            'Vazao_saida_ar': {'addr': 714, 'tipo': 'FP', 'l/e': 'l', 'div': 1, 'unid': 'm^3/h'},
            'Velocidade_saida_ar': {'addr': 712, 'tipo': 'FP', 'ymin': 0, 'ymax': 5, 'nick': 'Vel. saida','label': 'Velocidade de Saída do Ar', 'l/e': 'l', 'div': 1, 'unid': 'm/s'},
